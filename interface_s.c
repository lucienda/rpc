...
static const MIDL_STUB_DESC Interface_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& Interface_ServerInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const RPC_DISPATCH_FUNCTION Interface_NDR64__table[] =
    {
    NdrServerCallAll,
    NdrServerCallAll,
    NdrServerCallAll,
...
static const RPC_DISPATCH_TABLE Interface_NDR64__v1_0_DispatchTable = 
    {
    7,
    (RPC_DISPATCH_FUNCTION*)Interface_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO Interface_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&Interface_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE Interface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)FileSize,
    (SERVER_ROUTINE)Remove,
    (SERVER_ROUTINE)Authenticate,
    (SERVER_ROUTINE)Download,
    (SERVER_ROUTINE)Upload,
    (SERVER_ROUTINE)SecurityData,
    (SERVER_ROUTINE)Exit
    };
...
static const MIDL_SERVER_INFO Interface_ServerInfo = 
    ...
    interface__MIDL_ProcFormatString.Format,
    (unsigned short *) Interface_FormatStringOffsetTable,
    0,
